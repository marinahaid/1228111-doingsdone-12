                        ...
                        <ul class="main-navigation__list">
                            <?php foreach ($categories as $category => $category_name) : ?>
                                <li class="main-navigation__list-item">
                                 ...
                                 <span class="main-navigation__list-item-count"><?php require_once('utils.php'); ?></span>
                ...
                <main class="content__main">
                    ...
                    <div class="tasks-controls">
                        ...
                        <label class="checkbox">
                            <input class="checkbox__input visually-hidden show_completed <?= ($show_complete_tasks) && $task['is_complete'] ? ' checked' : ''; ?>" type="checkbox" value="1">
                                ...
                                <tr class="tasks__item task">
                                    <td class="task__select">
                                        <label class="checkbox task__checkbox">
                                            <input class="checkbox__input visually-hidden task__checkbox <?= ($show_completed_tasks) ? ' checked' : '' ?>" type="checkbox" value="0">
